...
for sub = 8:20
    ...
    [psds, freqs] = pwelch(VE_for_HMM.trial{1}', 500, [], [], VE_for_HMM.fsample);
...
cfg = [];
cfg.filetype = 'nifti';
cfg.filename = ['theta_abundance_eBOSC'];
cfg.parameter = 'pow';
...
try
    system(['/Applications/workbench/bin_macosx64/wb_command -volume-to-surface-mapping /Users/rseymoue/Documents/' ...
        'theta_abundance_eBOSC.nii /Applications/workbench/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.L.midthickness.32k_fs_LR.surf.gii /Users/rseymoue/Documents/' 'theta_abundance_eBOSC_LEFT.shape.gii -trilinear'])
    system(['/Applications/workbench/bin_macosx64/wb_command -volume-to-surface-mapping /Users/rseymoue/Documents/' ...
        'theta_abundance_eBOSC.nii /Applications/workbench/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.R.midthickness.32k_fs_LR.surf.gii /Users/rseymoue/Documents/' 'theta_abundance_eBOSC_RIGHT.shape.gii -trilinear'])
catch
